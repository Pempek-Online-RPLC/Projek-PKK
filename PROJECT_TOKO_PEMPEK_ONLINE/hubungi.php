...
<html lang="en">
  ...
  <header class="p-3 bg-warning text-black">
    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
      ...
      <div class="text-end">
        <button type="button" class="btn btn-outline-dark me-2"><a href="login.html">Masuk</a></button>
        <button type="button" class="btn btn-outline-dark me-2"><a href="daftar.html">Daftar</a></button>
      </div>
    </div>
  </header>
  <!-- Akhir Header -->
    ...
    <section id="produk">
      ...
      <div class="card position-absolute top-50 start-50 translate-middle" style="width: 31rem">
        <div class="card-body">
          <table>
            <tr>
              <td class="card-text fs-5">Nomor Whatsapp</td>
              <td class="card-text fs-5"></td>
              <td class="card-text fs-5">:</td>
              <td class="card-text fs-5">081234567812</td>
            </tr>
            <tr>
              <td class="card-text fs-5">Instagram</td>
              <td class="card-text fs-5"></td>
              <td class="card-text fs-5">:</td>
              <td class="card-text fs-5">@pempek.kaget</td>
            </tr>
            <tr>
              <td class="card-text fs-5">Facebook</td>
              <td class="card-text fs-5"></td>
              <td class="card-text fs-5">:</td>
              <td class="card-text fs-5">Pempek Kaget</td>
            </tr>
            <tr>
              <td class="card-text fs-5">Email</td>
              <td class="card-text fs-5"></td>
              <td class="card-text fs-5">:</td>
              <td class="card-text fs-5">pempekonlinekaget@gmail.com</td>
            </tr>
          </table>
        </div>
      </div>
